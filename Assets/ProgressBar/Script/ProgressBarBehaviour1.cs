...
namespace ProgressBar1
{
    ...
    public class ProgressBarBehaviour1 : MonoBehaviour, IIncrementable, IDecrementable
    {
		...
		void Detect_and_React(){
			...
			if (pgb_signal == "Bar 1 Completed") {
				ProgressBar.ProgressBarBehaviour.progress_bar_signal = "Progressing Bar 2";
			}
			if (pgb_signal == "Progressing Bar 2") {
				IncrementValue (1);
			}
		}
        ...
        {
			print ("Bar 2 Completed");
			ProgressBar.ProgressBarBehaviour.progress_bar_signal = "Bar 2 Completed";
