...
namespace ProgressBar3
{
    ...
    /// </summary>
    public class ProgressBarBehaviour3 : MonoBehaviour, IIncrementable, IDecrementable
    {
        /// <summary>
		...
		void Detect_and_React(){
			string pgb_signal = ProgressBar.ProgressBarBehaviour.progress_bar_signal;
			if (pgb_signal == "Bar 3 Completed") {
				ProgressBar.ProgressBarBehaviour.progress_bar_signal = "Progressing Bar 4";
			}
			if (pgb_signal == "Progressing Bar 4") {
				IncrementValue (1);
			}
        ...
        {
			print ("Bar 4 Completed");
			ProgressBar.ProgressBarBehaviour.progress_bar_signal = "Bar 4 Completed";
			StartCoroutine (Waiter());
			ProgressBar.ProgressBarBehaviour.progress_bar_signal = "Game Finished";
