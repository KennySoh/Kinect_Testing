...
namespace ProgressBar2
{
    ...
    public class ProgressBarBehaviour2 : MonoBehaviour, IIncrementable, IDecrementable
    {
		...
		void Detect_and_React(){
			...
			if (pgb_signal == "Bar 2 Completed") {
				ProgressBar.ProgressBarBehaviour.progress_bar_signal = "Progressing Bar 3";
			}
			if (pgb_signal == "Progressing Bar 3") {
				IncrementValue (1);
			}
		}
        ...
        {
			print ("Bar 3 Completed");
			ProgressBar.ProgressBarBehaviour.progress_bar_signal = "Bar 3 Completed";
